      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="mt-4 flex gap-2">
            <MapPin className="h-3.5 w-3.5 text-indigo-400 mt-0.5 shrink-0" />
            <div className="text-xs leading-relaxed"><span className="font-semibold text-slate-300">PUNE</span><br />Flat No.6, Janhavi Apartments, CTS No. 40/22, Shantabai Kalmadi Path, Bhonde Colony, Erandwane, Pune, Maharashtra 411004</div>
          </div>
        </div>
      </div>
